...
public interface AffichageConstantes {
	...
	final String[] lienImages = { "../images/ovale.jpg", "../images/rectangle.jpg", "../images/trait.jpg",
			"../images/bleuclair.jpg", "../images/bleumarin.jpg", "../images/jaune.jpg", "../images/mauve.jpg",
			"../images/noir.jpg", "../images/orange.jpg", "../images/fillrouge.png", "../images/fillrose.png",
			"../images/fillvert.png", "../images/fillnoir.png", "../images/filljaune.png", "../images/fillbleu.png" };

	// Tooltips
	final String[] tabToolTips = { "Ovale", "Rectangle", "Trait", "Contour bleu clair", "Contour bleu marin",
